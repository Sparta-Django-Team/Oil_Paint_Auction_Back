    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('painting', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='paintings', to='paintings.painting', verbose_name='유화')),
                ('seller', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auction_seller', to=settings.AUTH_USER_MODEL, verbose_name='판매자')),
            ],
            options={
                'db_table': 'auction',
                'ordering': ['id'],
