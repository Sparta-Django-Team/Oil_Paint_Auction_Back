    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(blank=True, max_length=20, verbose_name="제목"),
                ),
                (
                    "content",
                    models.TextField(blank=True, max_length=200, verbose_name="내용"),
                ),
                (
                    "before_image",
                    models.ImageField(
                        blank=True, upload_to="before_img", verbose_name="변환 전 사진"
                    ),
                ),
                (
                    "after_image",
                    models.ImageField(
                        blank=True, upload_to="after_img", verbose_name="변환 후 사진"
                    ),
                ),
                (
                    "created_at",
