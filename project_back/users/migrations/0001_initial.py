# Generated by Django 4.1.3 on 2022-11-22 10:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retention_period', models.TextField(choices=[(datetime.datetime(2023, 11, 22, 10, 26, 46, 369857), '1year')], default=datetime.datetime(2023, 11, 22, 10, 26, 46, 369857), verbose_name='회원정보 보유기간')),
                ...
                ('point', models.IntegerField(default=10000, verbose_name='포인트')),
            ],
            options={
                'abstract': False,
            },
